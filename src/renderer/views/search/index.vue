<template>
  <div class="search-page bg-app-gradient">
    <n-layout
      v-if="isMobile ? !searchDetail : true"
      class="hot-search glass rounded-2xl m-3 p-3 shadow-soft"
      :class="setAnimationClass('animate__fadeInDown')"
      :native-scrollbar="false"
    >
      <div class="title text-gradient">{{ t('search.title.hotSearch') }}</div>
    ...
    <n-layout
      v-if="isMobile ? searchDetail : true"
      class="search-list glass rounded-2xl m-3 p-3 shadow-soft"
      :class="setAnimationClass('animate__fadeInDown')"
      :native-scrollbar="false"
      @scroll="handleScroll"
    >
      <div v-if="searchDetail" class="title">
        ...
        ></i>
        <span class="text-gradient">{{ hotKeyword }}</span>
