<template>
  ...
  <n-modal
    ...
    :z-index="9999999"
  >
    <div class="audio-effects-modal-content">
...
import AudioEffectsControl from '@/components/AudioEffectsControl.vue';
...
const dropdownOptions = computed<DropdownOption[]>(() => [
  ...
  {
    label: t('player.playBar.audioEffects') || '音效处理',
    key: 'audioEffects',
    icon: () => h('i', { class: 'ri-sound-module-line' })
  },
  {
