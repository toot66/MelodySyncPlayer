<template>
  ...
  <div class="play-list-type">
    <div v-if="showTitle" class="title" :class="setAnimationClass('animate__fadeInLeft')">
...
.play-list-type {
  ...
  &-showall {
    ...
    @apply py-2 px-3 border border-gray-200 dark:border-gray-700 rounded-xl cursor-pointer hover:bg-green-600 hover:text-white transition;
  }
  &-showall {
    @apply block text-center col-span-5;
  }
}
