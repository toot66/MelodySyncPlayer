      ...
      <div v-if="!downloading" class="modal-desc mt-4 text-center">
        <p class="text-xs text-gray-400">
          ...
          <a
            ...
            target="_blank"
            :href="`https://github.com/${GH_OWNER}/${GH_REPO}/releases`"
            >GitHub</a
          >
...
// GitHub 仓库配置（可通过 .env 配置）
const GH_OWNER = import.meta.env.VITE_GH_OWNER || 'algerkong';
const GH_REPO = import.meta.env.VITE_GH_REPO || 'AlgerMusicPlayer';
...
const handleUpdate = async () => {
  ...
  const downUrls = {
    win32: {
      all: `https://github.com/${GH_OWNER}/${GH_REPO}/releases/download/v${version}/${GH_REPO}-${version}-win.exe`,
      x64: `https://github.com/${GH_OWNER}/${GH_REPO}/releases/download/v${version}/${GH_REPO}-${version}-win-x64.exe`,
      ia32: `https://github.com/${GH_OWNER}/${GH_REPO}/releases/download/v${version}/${GH_REPO}-${version}-win-ia32.exe`
    },
    darwin: {
      all: `https://github.com/${GH_OWNER}/${GH_REPO}/releases/download/v${version}/${GH_REPO}-${version}-mac-universal.dmg`
    },
    linux: {
      AppImage: `https://github.com/${GH_OWNER}/${GH_REPO}/releases/download/v${version}/${GH_REPO}-${version}-linux-x64.AppImage`,
      deb: `https://github.com/${GH_OWNER}/${GH_REPO}/releases/download/v${version}/${GH_REPO}-${version}-linux-x64.deb`
    }
  };
  ...
  if (downloadUrl) {
    ...
    window.open(`https://github.com/${GH_OWNER}/${GH_REPO}/releases/latest`, '_blank');
  }
};
</script>
