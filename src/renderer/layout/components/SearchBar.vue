<template>
  <div class="search-box flex glass shadow-soft rounded-2xl mx-3 mt-3 px-3 py-2">
...
const toGithubRelease = () => {
  if (updateInfo.value.hasUpdate) {
    ...
    window.open(`https://github.com/${GH_OWNER}/${GH_REPO}/releases`, '_blank');
  }
};
...
.github {
  ...
  @apply border dark:border-gray-600 border-gray-200 bg-transparent;
}
