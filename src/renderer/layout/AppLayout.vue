<template>
  <div class="layout-page bg-app-gradient">
    <div id="layout-main" class="layout-main">
      ...
      <div class="layout-main-page">
        ...
        <div class="main">
          ...
          <!-- 主页面路由 -->
          <div
            class="main-content glass rounded-2xl m-3 p-3 shadow-soft"
    ...
    <playlist-drawer v-if="currentSongId !== undefined" v-model="showPlaylistDrawer" :song-id="currentSongId" />
